...
{
    public class ReceivedMessageBuilder_NoResponseMessages
    {
        ...
        public void Setup()
        {
            ...
            try
            {
                _receivedMessages.AddRange(builder.BuildMessages(new Mock<IAmazonSQS>().Object, "request url", new List<Message>()));
            }
            catch (Exception e)
            {
                _caughtException = e;
